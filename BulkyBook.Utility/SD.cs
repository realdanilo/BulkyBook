...
{
    //add 'public static' words so can work as a reference on the main project
    public static class SD
    {
        ...
        public static double GetPriceBasedOnQty(double qty, double price, double price50, double price100)
        {
            if(qty < 50)
            {
                return price;
